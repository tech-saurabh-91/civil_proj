...
const defaultLineItems: LineItem[] = [
  { id: "LI-1", description: "Supply and installation of structural steel beams", unit: "Tonnes", qty: 45, rate: 98000, amount: 4410000 },
  { id: "LI-2", description: "RCC M30 concrete for columns and beams", unit: "Cum", qty: 320, rate: 5800, amount: 1856000 },
  { id: "LI-3", description: "Formwork for slab and beam shuttering", unit: "Sqm", qty: 2800, rate: 420, amount: 1176000 },
]

const defaultTerms = `1. Payment due within 30 days of invoice date.
2. GST @ 18% applicable on all items.
3. Late payment attracts 1.5% interest per month.
4. All disputes subject to Mumbai jurisdiction.
5. Material retention as per contract terms.`
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="e.g. Structural Steel Supply - Phase 1"
                  value={title}
            ...
            <div className="border rounded-lg p-6 space-y-4">
              <div className="flex items-center justify-between border-b pb-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Accounts & Billing Division</p>
                </div>
