        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-xl">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              <Button variant="outline" disabled className="opacity-50">
                <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M11.4 24H0V12.6h11.4V24zM24 24H12.6V12.6H24V24zM11.4 11.4H0V0h11.4v11.4zm12.6 0H12.6V0H24v11.4z"/></svg>
                Microsoft
              </Button>
            </div>
          </div>
